        ...
        <div className="container mx-auto px-4" style={{maxWidth: "1140px"}}>
          ...
          <div className="flex flex-col items-center lg:flex-row">
            ...
            <div className="mt-4 lg:mt-0 lg:w-5/12 lg:ml-auto">
              ...
              Of course, every mom says that, but they really, truly are. And everything I read in that book is part of
              what I do.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center lg:flex-row">
            ...
            <div className="mt-4 lg:mt-0 lg:w-5/12 lg:ml-auto">
              ...
              minutes and it was like that big of a changef. Because it was right at the core of what I really wanted to
